...
class TestCreateCwlPipeline(unittest.TestCase):
    """CreateCwlPipeline unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCwlPipeline:
        """Test CreateCwlPipeline
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCwlPipeline`
        """
        model = CreateCwlPipeline()
        if include_optional:
            return CreateCwlPipeline(
                ...
                description = '0',
                workflow_cwl_file = bytes(b'blah'),
                tool_cwl_files = [
                    bytes(b'blah')
                    ],
    ...
    def testCreateCwlPipeline(self):
        """Test CreateCwlPipeline"""
