...
class TestPipelineFileContentSpec(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PipelineFileContentSpec:
        """Test PipelineFileContentSpec
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PipelineFileContentSpec`
        """
        model = PipelineFileContentSpec()
        if include_optional:
            return PipelineFileContentSpec(
    ...
    def testPipelineFileContentSpec(self):
        """Test PipelineFileContentSpec"""
