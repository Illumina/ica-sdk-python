    ...
    def make_instance(self, include_optional) -> ProjectDataCopyBatchItemPagedList:
        ...
        if include_optional:
            return ProjectDataCopyBatchItemPagedList(
                items = [
                    icasdk.models.project_data_copy_batch_item.ProjectDataCopyBatchItem(
                        id = '', 
                        request = icasdk.models.project_data_copy_batch_item_request.ProjectDataCopyBatchItemRequest(
                            data_id = '', ), 
                        processing = icasdk.models.project_data_copy_batch_item_processing.ProjectDataCopyBatchItemProcessing(
                            status = 'QUEUED', 
