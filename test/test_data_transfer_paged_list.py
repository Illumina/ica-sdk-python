    ...
    def make_instance(self, include_optional) -> DataTransferPagedList:
        ...
        if include_optional:
            return DataTransferPagedList(
                items = [
                    icasdk.models.data_transfer.DataTransfer(
                        id = '', 
                        ...
                        reference = '0', 
                        direction = 'UPLOAD', 
                        connector = icasdk.models.connector.Connector(
                            id = '', 
                            time_created = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                            time_modified = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                            owner_id = '', 
                        ...
                        status_message = '0', 
                        duration = 0, 
                        project = icasdk.models.project.Project(
                            id = '', 
                            time_created = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                            time_modified = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                            owner_id = '', 
                            ...
                            tags = icasdk.models.project_tag.ProjectTag(
                                technical_tags = [
                                    ''
                                    ], 
                                user_tags = [
                            ...
                            storage_bundle = icasdk.models.storage_bundle.StorageBundle(
                                id = '', 
                                time_created = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                                time_modified = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                                owner_id = '', 
                                ...
                                region = icasdk.models.region.Region(
                                    ...
                                    country = icasdk.models.country.Country(
                                        ...
                                        region = '', ), 
                                    city_name = '0', ), ), 
                            self_managed_storage_configuration = icasdk.models.storage_configuration.StorageConfiguration(
                                id = '', 
                                time_created = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                                time_modified = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                                owner_id = '', 
                            ...
                            metadata_model = icasdk.models.metadata_model.MetadataModel(
                                ...
                                state = 'DRAFT', 
                                parent_model_id = '', ), 
                            application = icasdk.models.application.Application(
                                id = '', 
                                name = '', 
                                type = 'MAIN', 
                                display_name = '', ), ), 
                        data = icasdk.models.data.Data(
                            id = '0', 
                            urn = '0', 
