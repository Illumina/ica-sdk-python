...
class TestCreateNextflowPipeline(unittest.TestCase):
    """CreateNextflowPipeline unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateNextflowPipeline:
        """Test CreateNextflowPipeline
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateNextflowPipeline`
        """
        model = CreateNextflowPipeline()
        if include_optional:
            return CreateNextflowPipeline(
                ...
                description = '0',
                main_nextflow_file = bytes(b'blah'),
                nextflow_config_file = bytes(b'blah'),
                other_nextflow_files = [
                    bytes(b'blah')
                    ],
                parameters_xml_file = bytes(b'blah'),
                metadata_model_file = bytes(b'blah'),
                links = icasdk.models.links.Links(
                    links = [
                        icasdk.models.link.Link(
                            name = '0', 
                            url = '0', )
                        ], 
                    licenses = [
    ...
    def testCreateNextflowPipeline(self):
        """Test CreateNextflowPipeline"""
