...
------------ | ------------- | ------------- | ------------- | -------------
**code** | str,  | str,  | The country code as defined by ISO. | 
**name** | str,  | str,  | The full name of the country. | 
...
**region** | str,  | str,  | The region where the country belong to. | 
