# icasdk.model.reference_set.ReferenceSet
...
------------ | ------------- | ------------- | ------------- | -------------
**referenceDataList** | [**ReferenceDataList**](ReferenceDataList.md) | [**ReferenceDataList**](ReferenceDataList.md) |  | 
**name** | str,  | str,  | The name of the reference set | 
