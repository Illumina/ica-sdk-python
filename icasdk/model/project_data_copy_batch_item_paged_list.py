...
class ProjectDataCopyBatchItemPagedList(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ProjectDataCopyBatchItem']:
                        return ProjectDataCopyBatchItem
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ProjectDataCopyBatchItem'], typing.List['ProjectDataCopyBatchItem']],
                ...
                def __getitem__(self, i: int) -> 'ProjectDataCopyBatchItem':
