...
class AnalysisInputDataMount(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["dataId", "mountPath", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["dataId", "mountPath", ], str]):
