...
class UpdateSingleMetadataField(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["fieldId", "fieldName", "values", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["fieldId", "fieldName", "values", ], str]):
