...
class PipelineConfigurationParameterList(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['PipelineConfigurationParameter']:
                        return PipelineConfigurationParameter
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['PipelineConfigurationParameter'], typing.List['PipelineConfigurationParameter']],
                ...
                def __getitem__(self, i: int) -> 'PipelineConfigurationParameter':
