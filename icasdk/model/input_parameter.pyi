...
class InputParameter(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "code", "required", "multiValue", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "code", "required", "multiValue", ], str]):
