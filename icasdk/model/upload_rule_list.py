        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['UploadRule']:
                        return UploadRule
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['UploadRule'], typing.List['UploadRule']],
                ...
                def __getitem__(self, i: int) -> 'UploadRule':
