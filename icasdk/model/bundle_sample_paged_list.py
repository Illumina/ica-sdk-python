        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['BundleSample']:
                        return BundleSample
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['BundleSample'], typing.List['BundleSample']],
                ...
                def __getitem__(self, i: int) -> 'BundleSample':
