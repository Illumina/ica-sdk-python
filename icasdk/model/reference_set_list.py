        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ReferenceSet']:
                        return ReferenceSet
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ReferenceSet'], typing.List['ReferenceSet']],
                ...
                def __getitem__(self, i: int) -> 'ReferenceSet':
