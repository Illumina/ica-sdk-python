...
class AnalysisExternalData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["url", "type", "mountPath", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["url", "type", "mountPath", ], str]):
