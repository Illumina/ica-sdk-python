...
class SearchMatchingActivationCodesForNextflowAnalysis(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["projectId", "pipelineId", "analysisInput", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["projectId", "pipelineId", "analysisInput", ], str]):
