...
class Job(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class status(
                ...
                @schemas.classproperty
                def WAITING_FOR_RESOURCES(cls):
                    return cls("WAITING_FOR_RESOURCES")
                ...
                @schemas.classproperty
                def PARTIALLY_SUCCEEDED(cls):
                    return cls("PARTIALLY_SUCCEEDED")
                
                @schemas.classproperty
                def FAILED(cls):
                    return cls("FAILED")
            subjectType = schemas.StrSchema
            subjectId = schemas.UUIDSchema
    ...
    subjectId: MetaOapg.properties.subjectId
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["subjectId"]) -> MetaOapg.properties.subjectId: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["timeStarted"]) -> MetaOapg.properties.timeStarted: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["timeFinished"]) -> MetaOapg.properties.timeFinished: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "status", "subjectType", "subjectId", "timeCreated", "owner", "additionalStatusInformation", "timeStarted", "timeFinished", "project", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["subjectId"]) -> MetaOapg.properties.subjectId: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["timeCreated"]) -> MetaOapg.properties.timeCreated: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["owner"]) -> 'User': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["timeStarted"]) -> typing.Union[MetaOapg.properties.timeStarted, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["timeFinished"]) -> typing.Union[MetaOapg.properties.timeFinished, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "status", "subjectType", "subjectId", "timeCreated", "owner", "additionalStatusInformation", "timeStarted", "timeFinished", "project", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, None, ],
        ...
        timeStarted: typing.Union[MetaOapg.properties.timeStarted, None, str, datetime, schemas.Unset] = schemas.unset,
        timeFinished: typing.Union[MetaOapg.properties.timeFinished, None, str, datetime, schemas.Unset] = schemas.unset,
