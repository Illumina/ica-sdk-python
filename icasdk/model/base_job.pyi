...
class BaseJob(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class type(
                ...
                def COPYTABLE(cls):
                    return cls("COPYTABLE")
                
                @schemas.classproperty
                def EXPORTTABLE(cls):
                    return cls("EXPORTTABLE")
                
                @schemas.classproperty
                def CREATETABLE(cls):
                    return cls("CREATETABLE")
                
                @schemas.classproperty
                def EXECUTEQUERY(cls):
                    return cls("EXECUTEQUERY")
            ...
            @staticmethod
            def table() -> typing.Type['ProjectBaseTable']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["table"]) -> 'ProjectBaseTable': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["overallDuration"]) -> MetaOapg.properties.overallDuration: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["details"]) -> MetaOapg.properties.details: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["bytesBilled"]) -> MetaOapg.properties.bytesBilled: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "timeCreated", "timeModified", "ownerId", "tenantId", "type", "status", "tenantName", "description", "table", "overallDuration", "details", "bytesBilled", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["table"]) -> typing.Union['ProjectBaseTable', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["overallDuration"]) -> typing.Union[MetaOapg.properties.overallDuration, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["details"]) -> typing.Union[MetaOapg.properties.details, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["bytesBilled"]) -> typing.Union[MetaOapg.properties.bytesBilled, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "timeCreated", "timeModified", "ownerId", "tenantId", "type", "status", "tenantName", "description", "table", "overallDuration", "details", "bytesBilled", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        table: typing.Union['ProjectBaseTable', schemas.Unset] = schemas.unset,
        overallDuration: typing.Union[MetaOapg.properties.overallDuration, None, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        details: typing.Union[MetaOapg.properties.details, None, str, schemas.Unset] = schemas.unset,
        bytesBilled: typing.Union[MetaOapg.properties.bytesBilled, None, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
