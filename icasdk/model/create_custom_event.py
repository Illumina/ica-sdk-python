...
class CreateCustomEvent(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code", "content", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["code", "content", ], str]):
