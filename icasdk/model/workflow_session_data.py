...
class WorkflowSessionData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["dataId", "format", "name", "dataType", "mountPath", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["format"]) -> 'DataFormat': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["dataId", "format", "name", "dataType", "mountPath", ], str]):
