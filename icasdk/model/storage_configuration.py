...
class StorageConfiguration(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "timeCreated", "timeModified", "ownerId", "tenantId", "name", "type", "status", "region", "isDefault", "tenantName", "description", "errorMessage", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "timeCreated", "timeModified", "ownerId", "tenantId", "name", "type", "status", "region", "isDefault", "tenantName", "description", "errorMessage", ], str]):
