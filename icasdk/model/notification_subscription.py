...
class NotificationSubscription(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "timeCreated", "timeModified", "ownerId", "tenantId", "eventCode", "enabled", "notificationChannel", "tenantName", "filterExpression", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "timeCreated", "timeModified", "ownerId", "tenantId", "eventCode", "enabled", "notificationChannel", "tenantName", "filterExpression", ], str]):
