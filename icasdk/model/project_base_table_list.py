        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ProjectBaseTable']:
                        return ProjectBaseTable
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ProjectBaseTable'], typing.List['ProjectBaseTable']],
                ...
                def __getitem__(self, i: int) -> 'ProjectBaseTable':
