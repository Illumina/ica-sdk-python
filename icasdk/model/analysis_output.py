...
class AnalysisOutput(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class data(
                ...
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['AnalysisData'], typing.List['AnalysisData']],
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code", "projectId", "data", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["code", "projectId", "data", ], str]):
