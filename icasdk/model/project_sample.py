...
class ProjectSample(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["sample", "projectId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["sample", "projectId", ], str]):
