...
class ProjectDataLinkingBatchItemPagedList(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ProjectDataLinkingBatchItem']:
                        return ProjectDataLinkingBatchItem
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ProjectDataLinkingBatchItem'], typing.List['ProjectDataLinkingBatchItem']],
                ...
                def __getitem__(self, i: int) -> 'ProjectDataLinkingBatchItem':
