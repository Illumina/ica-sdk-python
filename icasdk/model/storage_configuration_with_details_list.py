...
class StorageConfigurationWithDetailsList(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['StorageConfigurationWithDetails']:
                        return StorageConfigurationWithDetails
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['StorageConfigurationWithDetails'], typing.List['StorageConfigurationWithDetails']],
                ...
                def __getitem__(self, i: int) -> 'StorageConfigurationWithDetails':
