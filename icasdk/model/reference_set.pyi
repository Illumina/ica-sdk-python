...
class ReferenceSet(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def referenceDataList() -> typing.Type['ReferenceDataList']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["referenceDataList"]) -> 'ReferenceDataList': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "timeCreated", "timeModified", "ownerId", "tenantId", "name", "referenceDataList", "tenantName", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["referenceDataList"]) -> 'ReferenceDataList': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "timeCreated", "timeModified", "ownerId", "tenantId", "name", "referenceDataList", "tenantName", ], str]):
