...
class CreateSampleCreationBatch(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['CreateSampleCreationBatchSampleItem']:
                        return CreateSampleCreationBatchSampleItem
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['CreateSampleCreationBatchSampleItem'], typing.List['CreateSampleCreationBatchSampleItem']],
                ...
                def __getitem__(self, i: int) -> 'CreateSampleCreationBatchSampleItem':
