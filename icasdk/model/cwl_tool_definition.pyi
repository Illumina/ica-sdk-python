...
class CWLToolDefinition(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class status(
                ...
                @schemas.classproperty
                def RELEASECANDIDATE(cls):
                    return cls("RELEASECANDIDATE")
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["links"]) -> 'Link': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "timeCreated", "timeModified", "ownerId", "tenantId", "name", "status", "tenantName", "description", "versionComment", "releaseVersion", "links", "categories", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["links"]) -> typing.Union['Link', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "timeCreated", "timeModified", "ownerId", "tenantId", "name", "status", "tenantName", "description", "versionComment", "releaseVersion", "links", "categories", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        releaseVersion: typing.Union[MetaOapg.properties.releaseVersion, None, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        links: typing.Union['Link', schemas.Unset] = schemas.unset,
