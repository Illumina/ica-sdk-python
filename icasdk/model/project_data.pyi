...
class ProjectData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["data", "projectId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["data", "projectId", ], str]):
