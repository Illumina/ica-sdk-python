...
class AnalysisCreationBatchItemRequest(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            userReference = schemas.StrSchema
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["userReference", "pipelineId", "tags", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["userReference", "pipelineId", "tags", ], str]):
