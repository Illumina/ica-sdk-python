...
class WorkflowSessionPagedList(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['WorkflowSession']:
                        return WorkflowSession
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['WorkflowSession'], typing.List['WorkflowSession']],
                ...
                def __getitem__(self, i: int) -> 'WorkflowSession':
