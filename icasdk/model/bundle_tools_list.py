        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['BundleTool']:
                        return BundleTool
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['BundleTool'], typing.List['BundleTool']],
                ...
                def __getitem__(self, i: int) -> 'BundleTool':
