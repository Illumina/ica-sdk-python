...
class ActivationCodeDetailUsage(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "usedSlots", "allowedSlots", "project", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "usedSlots", "allowedSlots", "project", ], str]):
