        ...
        class properties:
            ...
            class items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['AnalysisStep']:
                        return AnalysisStep
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['AnalysisStep'], typing.List['AnalysisStep']],
                ...
                def __getitem__(self, i: int) -> 'AnalysisStep':
