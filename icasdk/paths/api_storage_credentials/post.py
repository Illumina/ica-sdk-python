...
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = CreateStorageCredential
SchemaForRequestBodyApplicationJson = CreateStorageCredential


request_body_create_storage_credential = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationVndIlluminaV3json = StorageCredential
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_storage_credential_oapg(
        self,
    ...
    def _create_storage_credential_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_storage_credential.serialize(body, content_type)
...
class CreateStorageCredential(BaseApi):
    ...
    def create_storage_credential(
        ...
        return self._create_storage_credential_oapg(
            body=body,
