...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = AnalysisCreationBatchItem
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_analysis_creation_batch_item1_oapg(
        self,
...
class GetAnalysisCreationBatchItem1(BaseApi):
    ...
    def get_analysis_creation_batch_item1(
        ...
        return self._get_analysis_creation_batch_item1_oapg(
