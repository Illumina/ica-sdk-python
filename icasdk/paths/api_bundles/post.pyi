...
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = CreateBundle
SchemaForRequestBodyApplicationJson = CreateBundle


request_body_create_bundle = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationVndIlluminaV3json = Bundle
...
class BaseApi(api_client.Api):
    ...
    def _create_bundle_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_bundle.serialize(body, content_type)
...
class CreateBundle(BaseApi):
    ...
    def create_bundle(
        ...
        return self._create_bundle_oapg(
            body=body,
