...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = CustomNotificationSubscriptionList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_notification_subscriptions_oapg(
        self,
...
class GetNotificationSubscriptions(BaseApi):
    ...
    def get_notification_subscriptions(
        ...
        return self._get_notification_subscriptions_oapg(
