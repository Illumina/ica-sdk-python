...
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = CreateCustomNotificationSubscription
SchemaForRequestBodyApplicationJson = CreateCustomNotificationSubscription


request_body_create_custom_notification_subscription = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = CustomNotificationSubscription
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_notification_subscription_oapg(
        self,
    ...
    def _create_notification_subscription_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_custom_notification_subscription.serialize(body, content_type)
...
class CreateNotificationSubscription(BaseApi):
    ...
    def create_notification_subscription(
        ...
        return self._create_notification_subscription_oapg(
            body=body,
