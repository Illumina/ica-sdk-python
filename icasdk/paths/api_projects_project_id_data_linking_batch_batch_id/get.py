...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = ProjectDataLinkingBatch
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_project_data_linking_batch_oapg(
        self,
...
class GetProjectDataLinkingBatch(BaseApi):
    ...
    def get_project_data_linking_batch(
        ...
        return self._get_project_data_linking_batch_oapg(
