...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = ProjectDataCopyBatchItem
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_project_data_copy_batch_item_oapg(
        self,
...
class GetProjectDataCopyBatchItem(BaseApi):
    ...
    def get_project_data_copy_batch_item(
        ...
        return self._get_project_data_copy_batch_item_oapg(
