...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = AnalysisRawOutput
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_raw_analysis_output_oapg(
        self,
...
class GetRawAnalysisOutput(BaseApi):
    ...
    def get_raw_analysis_output(
        ...
        return self._get_raw_analysis_output_oapg(
