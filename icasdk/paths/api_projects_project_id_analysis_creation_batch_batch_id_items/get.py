...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = AnalysisCreationBatchItemPagedList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_analysis_creation_batch_item_oapg(
        self,
...
class GetAnalysisCreationBatchItem(BaseApi):
    ...
    def get_analysis_creation_batch_item(
        ...
        return self._get_analysis_creation_batch_item_oapg(
