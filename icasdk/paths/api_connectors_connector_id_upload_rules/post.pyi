...
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = CreateUploadRule
SchemaForRequestBodyApplicationJson = CreateUploadRule


request_body_create_upload_rule = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationVndIlluminaV3json = UploadRule
...
class BaseApi(api_client.Api):
    ...
    def _create_upload_rule_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_upload_rule.serialize(body, content_type)
...
class CreateUploadRule(BaseApi):
    ...
    def create_upload_rule(
        ...
        return self._create_upload_rule_oapg(
            body=body,
