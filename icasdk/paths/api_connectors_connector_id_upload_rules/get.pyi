...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = UploadRuleList
...
class GetUploadRules(BaseApi):
    ...
    def get_upload_rules(
        ...
        return self._get_upload_rules_oapg(
