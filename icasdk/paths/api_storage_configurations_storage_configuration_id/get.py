...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = StorageConfiguration
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_storage_configuration_oapg(
        self,
...
class GetStorageConfiguration(BaseApi):
    ...
    def get_storage_configuration(
        ...
        return self._get_storage_configuration_oapg(
