...
# Path params
MetadataModelIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'metadataModelId': typing.Union[MetadataModelIdSchema, str, ],
    }
)
...
request_path_metadata_model_id = api_client.PathParameter(
    name="metadataModelId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=MetadataModelIdSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = FieldList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_metadata_model_fields_oapg(
        self,
    ...
    def _get_metadata_model_fields_oapg(
        ...
        _path_params = {}
        for parameter in (
            request_path_metadata_model_id,
        ):
...
class GetMetadataModelFields(BaseApi):
    ...
    def get_metadata_model_fields(
        ...
        return self._get_metadata_model_fields_oapg(
