...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = InputParameterList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_project_pipeline_input_parameters_oapg(
        self,
...
class GetProjectPipelineInputParameters(BaseApi):
    ...
    def get_project_pipeline_input_parameters(
        ...
        return self._get_project_pipeline_input_parameters_oapg(
