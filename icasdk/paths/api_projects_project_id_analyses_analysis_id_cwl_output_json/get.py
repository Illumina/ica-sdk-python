...
AnalysisIdSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'projectId': typing.Union[ProjectIdSchema, str, ],
        'analysisId': typing.Union[AnalysisIdSchema, str, uuid.UUID, ],
    }
)
...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = CwlAnalysisOutputJson
...
class GetCwlOutputJson(BaseApi):
    ...
    def get_cwl_output_json(
        ...
        return self._get_cwl_output_json_oapg(
