...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = AnalysisStepList
...
class GetAnalysisSteps(BaseApi):
    ...
    def get_analysis_steps(
        ...
        return self._get_analysis_steps_oapg(
