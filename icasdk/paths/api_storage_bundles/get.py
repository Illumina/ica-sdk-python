...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = StorageBundleList
...
class GetStorageBundles(BaseApi):
    ...
    def get_storage_bundles(
        ...
        return self._get_storage_bundles_oapg(
