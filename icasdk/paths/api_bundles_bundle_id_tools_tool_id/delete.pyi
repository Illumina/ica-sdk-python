...
ToolIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'bundleId': typing.Union[BundleIdSchema, str, ],
        'toolId': typing.Union[ToolIdSchema, str, ],
    }
)
...
request_path_tool_id = api_client.PathParameter(
    name="toolId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ToolIdSchema,
    required=True,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _unlink_tool_from_bundle_oapg(
        self,
...
class UnlinkToolFromBundle(BaseApi):
    ...
    def unlink_tool_from_bundle(
        ...
        return self._unlink_tool_from_bundle_oapg(
