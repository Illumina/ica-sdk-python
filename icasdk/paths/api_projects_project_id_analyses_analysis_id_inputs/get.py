...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = AnalysisInputList
...
class GetAnalysisInputs(BaseApi):
    ...
    def get_analysis_inputs(
        ...
        return self._get_analysis_inputs_oapg(
