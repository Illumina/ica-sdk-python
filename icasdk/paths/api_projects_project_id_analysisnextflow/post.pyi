...
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = CreateNextflowAnalysis


request_body_create_nextflow_analysis = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationVndIlluminaV3json = Analysis
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_nextflow_analysis_oapg(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationVndIlluminaV3json,],
        content_type: str = ...,
    ...
    def _create_nextflow_analysis_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_nextflow_analysis.serialize(body, content_type)
...
class CreateNextflowAnalysis(BaseApi):
    ...
    def create_nextflow_analysis(
        ...
        return self._create_nextflow_analysis_oapg(
            body=body,
