...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = SampleHistoryList
...
class GetSampleHistory(BaseApi):
    ...
    def get_sample_history(
        ...
        return self._get_sample_history_oapg(
