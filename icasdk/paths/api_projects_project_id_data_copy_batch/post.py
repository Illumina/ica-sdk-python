...
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = CreateProjectDataCopyBatch
SchemaForRequestBodyApplicationJson = CreateProjectDataCopyBatch


request_body_create_project_data_copy_batch = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationVndIlluminaV3json = ProjectDataCopyBatch
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_project_data_copy_batch_oapg(
        self,
    ...
    def _create_project_data_copy_batch_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_project_data_copy_batch.serialize(body, content_type)
...
class CreateProjectDataCopyBatch(BaseApi):
    ...
    def create_project_data_copy_batch(
        ...
        return self._create_project_data_copy_batch_oapg(
            body=body,
