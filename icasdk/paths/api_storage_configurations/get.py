...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = StorageConfigurationWithDetailsList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_storage_configurations_oapg(
        self,
...
class GetStorageConfigurations(BaseApi):
    ...
    def get_storage_configurations(
        ...
        return self._get_storage_configurations_oapg(
