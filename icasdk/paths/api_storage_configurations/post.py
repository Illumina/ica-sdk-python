...
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = CreateStorageConfiguration
SchemaForRequestBodyApplicationJson = CreateStorageConfiguration


request_body_create_storage_configuration = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationVndIlluminaV3json = StorageConfiguration
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_storage_configuration_oapg(
        self,
    ...
    def _create_storage_configuration_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_storage_configuration.serialize(body, content_type)
...
class CreateStorageConfiguration(BaseApi):
    ...
    def create_storage_configuration(
        ...
        return self._create_storage_configuration_oapg(
            body=body,
