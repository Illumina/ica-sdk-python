...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = Download
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_download_url_for_data_without_project_context_oapg(
        self,
...
class CreateDownloadUrlForDataWithoutProjectContext(BaseApi):
    ...
    def create_download_url_for_data_without_project_context(
        ...
        return self._create_download_url_for_data_without_project_context_oapg(
