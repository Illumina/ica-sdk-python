...
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = NotificationSubscription
SchemaForRequestBodyApplicationJson = NotificationSubscription


request_body_notification_subscription = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_notification_subscription1_oapg(
        self,
    ...
    def _update_notification_subscription1_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_notification_subscription.serialize(body, content_type)
...
class UpdateNotificationSubscription1(BaseApi):
    ...
    def update_notification_subscription1(
        ...
        return self._update_notification_subscription1_oapg(
            body=body,
