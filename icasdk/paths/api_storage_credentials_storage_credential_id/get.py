...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = StorageCredential
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_storage_credential_oapg(
        self,
...
class GetStorageCredential(BaseApi):
    ...
    def get_storage_credential(
        ...
        return self._get_storage_credential_oapg(
