...
DataTransferIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'projectId': typing.Union[ProjectIdSchema, str, ],
        'dataTransferId': typing.Union[DataTransferIdSchema, str, ],
    }
)
...
request_path_data_transfer_id = api_client.PathParameter(
    name="dataTransferId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=DataTransferIdSchema,
    required=True,
)
_auth = [
    'ApiKeyAuth',
...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = DataTransfer
...
class GetDataTransfer(BaseApi):
    ...
    def get_data_transfer(
        ...
        return self._get_data_transfer_oapg(
