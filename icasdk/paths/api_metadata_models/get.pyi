...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = MetadataModelList
...
class GetMetadataModels(BaseApi):
    ...
    def get_metadata_models(
        ...
        return self._get_metadata_models_oapg(
