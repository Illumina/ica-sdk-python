...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = EventCodeList
...
class GetEventCodes(BaseApi):
    ...
    def get_event_codes(
        ...
        return self._get_event_codes_oapg(
