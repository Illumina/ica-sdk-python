...
# body param
SchemaForRequestBodyMultipartFormData = CreateCwlPipeline
...
class CreateCwlPipeline(BaseApi):
    ...
    def create_cwl_pipeline(
        ...
        return self._create_cwl_pipeline_oapg(
            body=body,
