...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = ProjectPipelineList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_project_pipelines_oapg(
        self,
...
class GetProjectPipelines(BaseApi):
    ...
    def get_project_pipelines(
        ...
        return self._get_project_pipelines_oapg(
