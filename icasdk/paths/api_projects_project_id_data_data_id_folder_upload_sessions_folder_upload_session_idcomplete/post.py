...
DataIdSchema = schemas.StrSchema
FolderUploadSessionIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'projectId': typing.Union[ProjectIdSchema, str, ],
        'dataId': typing.Union[DataIdSchema, str, ],
        'folderUploadSessionId': typing.Union[FolderUploadSessionIdSchema, str, ],
    }
)
...
request_path_data_id = api_client.PathParameter(
    name="dataId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=DataIdSchema,
    required=True,
)
request_path_folder_upload_session_id = api_client.PathParameter(
    name="folderUploadSessionId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=FolderUploadSessionIdSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = CompleteFolderUploadSession
SchemaForRequestBodyApplicationJson = CompleteFolderUploadSession


request_body_complete_folder_upload_session = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _complete_folder_upload_session_oapg(
        self,
    ...
    def _complete_folder_upload_session_oapg(
        ...
        for parameter in (
            ...
            request_path_data_id,
            request_path_folder_upload_session_id,
        ):
        ...
        _fields = None
        _body = None
        serialized_data = request_body_complete_folder_upload_session.serialize(body, content_type)
...
class CompleteFolderUploadSession(BaseApi):
    ...
    def complete_folder_upload_session(
        ...
        return self._complete_folder_upload_session_oapg(
            body=body,
