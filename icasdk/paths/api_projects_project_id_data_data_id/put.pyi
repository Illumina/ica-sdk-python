...
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = ProjectData
SchemaForRequestBodyApplicationJson = ProjectData


request_body_project_data = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = ProjectData
...
class BaseApi(api_client.Api):
    ...
    def _update_project_data_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_project_data.serialize(body, content_type)
...
class UpdateProjectData(BaseApi):
    ...
    def update_project_data(
        ...
        return self._update_project_data_oapg(
            body=body,
