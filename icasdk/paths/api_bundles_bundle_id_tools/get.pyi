...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = BundleToolsList
...
class GetBundleTools(BaseApi):
    ...
    def get_bundle_tools(
        ...
        return self._get_bundle_tools_oapg(
