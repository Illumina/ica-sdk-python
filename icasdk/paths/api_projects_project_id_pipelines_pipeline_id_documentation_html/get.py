...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = PipelineHtmlDocumentation
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_project_pipeline_html_documentation_oapg(
        self,
...
class GetProjectPipelineHtmlDocumentation(BaseApi):
    ...
    def get_project_pipeline_html_documentation(
        ...
        return self._get_project_pipeline_html_documentation_oapg(
