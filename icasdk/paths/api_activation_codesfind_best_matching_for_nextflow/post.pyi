...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = ActivationCodeDetail
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_best_matching_activation_codes_for_nextflow_oapg(
        self,
...
class FindBestMatchingActivationCodesForNextflow(BaseApi):
    ...
    def find_best_matching_activation_codes_for_nextflow(
        ...
        return self._find_best_matching_activation_codes_for_nextflow_oapg(
            body=body,
