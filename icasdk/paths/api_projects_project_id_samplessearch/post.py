...
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = FindProjectSamples
SchemaForRequestBodyApplicationJson = FindProjectSamples


request_body_find_project_samples = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = ProjectSamplePagedList
...
class BaseApi(api_client.Api):
    ...
    def _get_project_samples_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_find_project_samples.serialize(body, content_type)
...
class GetProjectSamples(BaseApi):
    ...
    def get_project_samples(
        ...
        return self._get_project_samples_oapg(
            body=body,
