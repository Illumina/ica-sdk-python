...
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = CreateProjectDataLinkingBatch
SchemaForRequestBodyApplicationJson = CreateProjectDataLinkingBatch


request_body_create_project_data_linking_batch = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationVndIlluminaV3json = ProjectDataLinkingBatch
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_project_data_linking_batch_oapg(
        self,
    ...
    def _create_project_data_linking_batch_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_project_data_linking_batch.serialize(body, content_type)
...
class CreateProjectDataLinkingBatch(BaseApi):
    ...
    def create_project_data_linking_batch(
        ...
        return self._create_project_data_linking_batch_oapg(
            body=body,
