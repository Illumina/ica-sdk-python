...
# Path params
EntitledBundleIdSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'entitledBundleId': typing.Union[EntitledBundleIdSchema, str, uuid.UUID, ],
    }
)
...
request_path_entitled_bundle_id = api_client.PathParameter(
    name="entitledBundleId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=EntitledBundleIdSchema,
    required=True,
)
_auth = [
    'ApiKeyAuth',
...
class BaseApi(api_client.Api):
    ...
    def _get_entitled_bundle_oapg(
        ...
        _path_params = {}
        for parameter in (
            request_path_entitled_bundle_id,
        ):
...
class GetEntitledBundle(BaseApi):
    ...
    def get_entitled_bundle(
        ...
        return self._get_entitled_bundle_oapg(
