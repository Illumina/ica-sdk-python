...
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = CreateSampleCreationBatch
SchemaForRequestBodyApplicationXWwwFormUrlencoded = CreateSampleCreationBatch
SchemaForRequestBodyApplicationJson = CreateSampleCreationBatch


request_body_create_sample_creation_batch = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_sample_creation_batch_oapg(
        self,
    ...
    def _create_sample_creation_batch_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_sample_creation_batch.serialize(body, content_type)
...
class CreateSampleCreationBatch(BaseApi):
    ...
    def create_sample_creation_batch(
        ...
        return self._create_sample_creation_batch_oapg(
            body=body,
