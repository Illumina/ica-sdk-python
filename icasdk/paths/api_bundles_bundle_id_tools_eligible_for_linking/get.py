...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = CwlToolDefinitionList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_tools_eligible_for_linking_to_bundle_oapg(
        self,
...
class GetToolsEligibleForLinkingToBundle(BaseApi):
    ...
    def get_tools_eligible_for_linking_to_bundle(
        ...
        return self._get_tools_eligible_for_linking_to_bundle_oapg(
