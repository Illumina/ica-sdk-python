...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = ProjectDataLinkingBatchItem
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_project_data_linking_batch_item_oapg(
        self,
...
class GetProjectDataLinkingBatchItem(BaseApi):
    ...
    def get_project_data_linking_batch_item(
        ...
        return self._get_project_data_linking_batch_item_oapg(
