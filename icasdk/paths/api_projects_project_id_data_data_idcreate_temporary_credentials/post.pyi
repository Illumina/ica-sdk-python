...
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = CreateTemporaryCredentials
SchemaForRequestBodyApplicationJson = CreateTemporaryCredentials


request_body_create_temporary_credentials = api_client.RequestBody(
    content={
...
class CreateTemporaryCredentialsForData(BaseApi):
    ...
    def create_temporary_credentials_for_data(
        ...
        return self._create_temporary_credentials_for_data_oapg(
            body=body,
