...
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = CreateData
SchemaForRequestBodyApplicationJson = CreateData


request_body_create_data = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationVndIlluminaV3json = ProjectData
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_data_in_project_oapg(
        self,
    ...
    def _create_data_in_project_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_data.serialize(body, content_type)
...
class CreateDataInProject(BaseApi):
