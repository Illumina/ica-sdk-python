...
# Query params
ConnectorSchema = schemas.StrSchema
...
request_query_connector = api_client.QueryParameter(
    name="connector",
...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = DataTransferPagedList
...
class GetDataTransfers(BaseApi):
    ...
    def get_data_transfers(
        ...
        return self._get_data_transfers_oapg(
