...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = PipelineConfigurationParameterList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_project_pipeline_configuration_parameters_oapg(
        self,
...
class GetProjectPipelineConfigurationParameters(BaseApi):
    ...
    def get_project_pipeline_configuration_parameters(
        ...
        return self._get_project_pipeline_configuration_parameters_oapg(
