...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = AnalysisStorageList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_analysis_storage_options_oapg(
        self,
...
class GetAnalysisStorageOptions(BaseApi):
    ...
    def get_analysis_storage_options(
        ...
        return self._get_analysis_storage_options_oapg(
