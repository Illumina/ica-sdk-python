...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = WorkflowSessionInputList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_workflow_session_inputs_oapg(
        self,
...
class GetWorkflowSessionInputs(BaseApi):
    ...
    def get_workflow_session_inputs(
        ...
        return self._get_workflow_session_inputs_oapg(
