...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = ExecutionConfigurationList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_analysis_configurations_oapg(
        self,
...
class GetAnalysisConfigurations(BaseApi):
    ...
    def get_analysis_configurations(
        ...
        return self._get_analysis_configurations_oapg(
