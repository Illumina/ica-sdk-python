...
class StatusSchema(
    ...
    class MetaOapg:
        ...
        class items(
            ...
            @schemas.classproperty
            def PARTIALLY_COPIED(cls):
                return cls("PARTIALLY_COPIED")
...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = ProjectDataCopyBatchItemPagedList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_project_data_copy_batch_items_oapg(
        self,
...
class GetProjectDataCopyBatchItems(BaseApi):
    ...
    def get_project_data_copy_batch_items(
        ...
        return self._get_project_data_copy_batch_items_oapg(
