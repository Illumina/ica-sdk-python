...
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = CustomNotificationSubscription
SchemaForRequestBodyApplicationJson = CustomNotificationSubscription


request_body_custom_notification_subscription = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_notification_subscription_oapg(
        self,
    ...
    def _update_notification_subscription_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_custom_notification_subscription.serialize(body, content_type)
...
class UpdateNotificationSubscription(BaseApi):
    ...
    def update_notification_subscription(
        ...
        return self._update_notification_subscription_oapg(
            body=body,
