...
# Path params
ReferenceSetIdSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'referenceSetId': typing.Union[ReferenceSetIdSchema, str, uuid.UUID, ],
    }
)
...
request_path_reference_set_id = api_client.PathParameter(
    name="referenceSetId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ReferenceSetIdSchema,
    required=True,
)
_auth = [
    'JwtAuth',
...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = SpeciesList
