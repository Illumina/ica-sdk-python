...
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = LoadDataInBaseRequest
SchemaForRequestBodyApplicationJson = LoadDataInBaseRequest


request_body_load_data_in_base_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _load_data_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_load_data_in_base_request.serialize(body, content_type)
