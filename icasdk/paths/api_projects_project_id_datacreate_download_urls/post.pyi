...
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = DataIdOrPathList


request_body_data_id_or_path_list = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_download_urls_for_data_oapg(
        self,
    ...
    def _create_download_urls_for_data_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_data_id_or_path_list.serialize(body, content_type)
...
class CreateDownloadUrlsForData(BaseApi):
    ...
    def create_download_urls_for_data(
        ...
        return self._create_download_urls_for_data_oapg(
            body=body,
