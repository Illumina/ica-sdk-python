...
BaseJobIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'projectId': typing.Union[ProjectIdSchema, str, ],
        'baseJobId': typing.Union[BaseJobIdSchema, str, ],
    }
)
...
request_path_base_job_id = api_client.PathParameter(
    name="baseJobId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=BaseJobIdSchema,
    required=True,
)
_auth = [
    'JwtAuth',
...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = BaseJob
...
class GetBaseJob(BaseApi):
    ...
    def get_base_job(
        ...
        return self._get_base_job_oapg(
