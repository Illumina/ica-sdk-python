...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = WorkflowSessionPagedList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_workflow_sessions_oapg(
        self,
...
class GetWorkflowSessions(BaseApi):
    ...
    def get_workflow_sessions(
        ...
        return self._get_workflow_sessions_oapg(
