...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = ProjectBundleList
...
class GetProjectBundles(BaseApi):
    ...
    def get_project_bundles(
        ...
        return self._get_project_bundles_oapg(
