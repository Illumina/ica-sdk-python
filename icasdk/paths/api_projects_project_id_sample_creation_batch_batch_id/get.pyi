...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = SampleCreationBatch
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_sample_creation_batch_oapg(
        self,
...
class GetSampleCreationBatch(BaseApi):
    ...
    def get_sample_creation_batch(
        ...
        return self._get_sample_creation_batch_oapg(
