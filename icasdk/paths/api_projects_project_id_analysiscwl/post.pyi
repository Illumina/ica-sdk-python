...
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = CreateCwlAnalysis


request_body_create_cwl_analysis = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_cwl_analysis_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_cwl_analysis.serialize(body, content_type)
...
class CreateCwlAnalysis(BaseApi):
    ...
    def create_cwl_analysis(
        ...
        return self._create_cwl_analysis_oapg(
            body=body,
