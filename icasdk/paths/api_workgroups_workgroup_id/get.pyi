...
# Path params
WorkgroupIdSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'workgroupId': typing.Union[WorkgroupIdSchema, str, uuid.UUID, ],
    }
)
...
request_path_workgroup_id = api_client.PathParameter(
    name="workgroupId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=WorkgroupIdSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = Workgroup
...
class GetWorkgroup(BaseApi):
    ...
    def get_workgroup(
        ...
        return self._get_workgroup_oapg(
