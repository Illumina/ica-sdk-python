...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = CwlAnalysisInputJson
...
class GetCwlInputJson(BaseApi):
    ...
    def get_cwl_input_json(
        ...
        return self._get_cwl_input_json_oapg(
