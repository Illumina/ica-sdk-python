...
DownloadRuleIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'connectorId': typing.Union[ConnectorIdSchema, str, ],
        'downloadRuleId': typing.Union[DownloadRuleIdSchema, str, ],
    }
)
...
request_path_download_rule_id = api_client.PathParameter(
    name="downloadRuleId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=DownloadRuleIdSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = DownloadRule
SchemaForRequestBodyApplicationJson = DownloadRule


request_body_download_rule = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = DownloadRule
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_download_rule_oapg(
        self,
    ...
    def _update_download_rule_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_download_rule.serialize(body, content_type)
...
class UpdateDownloadRule(BaseApi):
    ...
    def update_download_rule(
        ...
        return self._update_download_rule_oapg(
            body=body,
