...
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = CreateTermsOfUse
SchemaForRequestBodyApplicationXWwwFormUrlencoded = CreateTermsOfUse
SchemaForRequestBodyApplicationJson = CreateTermsOfUse


request_body_create_terms_of_use = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _insert_bundle_terms_of_use_oapg(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationVndIlluminaV3json,SchemaForRequestBodyApplicationXWwwFormUrlencoded,SchemaForRequestBodyApplicationJson,],
        content_type: str = ...,
    ...
    def _insert_bundle_terms_of_use_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_terms_of_use.serialize(body, content_type)
...
class InsertBundleTermsOfUse(BaseApi):
    ...
    def insert_bundle_terms_of_use(
        ...
        return self._insert_bundle_terms_of_use_oapg(
            body=body,
