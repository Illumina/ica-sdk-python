...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_pipeline_configuration_parameters_oapg(
        self,
...
class GetPipelineConfigurationParameters(BaseApi):
    ...
    def get_pipeline_configuration_parameters(
        ...
        return self._get_pipeline_configuration_parameters_oapg(
