...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = BaseConnection
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_base_connection_details_oapg(
        self,
...
class CreateBaseConnectionDetails(BaseApi):
    ...
    def create_base_connection_details(
        ...
        return self._create_base_connection_details_oapg(
