...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = ProjectList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_projects_linked_to_data_oapg(
        self,
...
class GetProjectsLinkedToData(BaseApi):
    ...
    def get_projects_linked_to_data(
        ...
        return self._get_projects_linked_to_data_oapg(
