...
SchemaFor200ResponseBodyApplicationVndIlluminaV4json = ProjectDataPagedList
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = DataList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_project_data_children_oapg(
        self,
...
class GetProjectDataChildren(BaseApi):
    ...
    def get_project_data_children(
        ...
        return self._get_project_data_children_oapg(
