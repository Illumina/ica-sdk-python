...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = ReferenceSetList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_project_pipeline_reference_sets_oapg(
        self,
...
class GetProjectPipelineReferenceSets(BaseApi):
    ...
    def get_project_pipeline_reference_sets(
        ...
        return self._get_project_pipeline_reference_sets_oapg(
