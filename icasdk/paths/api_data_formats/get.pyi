...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = DataFormatPagedList
...
class GetDataFormats(BaseApi):
    ...
    def get_data_formats(
        ...
        return self._get_data_formats_oapg(
