...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = ProjectBaseTableList
...
class GetBaseTables(BaseApi):
    ...
    def get_base_tables(
        ...
        return self._get_base_tables_oapg(
