...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = AnalysisCreationBatch
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_analysis_creation_batch_oapg(
        self,
...
class GetAnalysisCreationBatch(BaseApi):
    ...
    def get_analysis_creation_batch(
        ...
        return self._get_analysis_creation_batch_oapg(
