...
# Query params
ActiveOnlySchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'activeOnly': typing.Union[ActiveOnlySchema, bool, ],
    },
    total=False
)
...
request_query_active_only = api_client.QueryParameter(
    name="activeOnly",
    style=api_client.ParameterStyle.FORM,
    schema=ActiveOnlySchema,
    explode=True,
)
_auth = [
    'ApiKeyAuth',
...
class GetConnectors(BaseApi):
    ...
    def get_connectors(
        ...
        return self._get_connectors_oapg(
