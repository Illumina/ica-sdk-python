...
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = CreateConnector
SchemaForRequestBodyApplicationJson = CreateConnector


request_body_create_connector = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationVndIlluminaV3json = Connector
...
class BaseApi(api_client.Api):
    ...
    def _create_connector_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_connector.serialize(body, content_type)
...
class CreateConnector(BaseApi):
    ...
    def create_connector(
        ...
        return self._create_connector_oapg(
            body=body,
