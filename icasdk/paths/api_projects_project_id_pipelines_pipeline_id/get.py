...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = ProjectPipeline
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_project_pipeline_oapg(
        self,
...
class GetProjectPipeline(BaseApi):
    ...
    def get_project_pipeline(
        ...
        return self._get_project_pipeline_oapg(
