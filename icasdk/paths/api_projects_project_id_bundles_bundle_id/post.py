...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = ProjectBundle
...
class LinkProjectBundle(BaseApi):
    ...
    def link_project_bundle(
        ...
        return self._link_project_bundle_oapg(
