...
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = CreateNotificationChannel
SchemaForRequestBodyApplicationJson = CreateNotificationChannel


request_body_create_notification_channel = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationVndIlluminaV3json = NotificationChannel
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_notification_channel_oapg(
        self,
    ...
    def _create_notification_channel_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_notification_channel.serialize(body, content_type)
...
class CreateNotificationChannel(BaseApi):
    ...
    def create_notification_channel(
        ...
        return self._create_notification_channel_oapg(
            body=body,
