...
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = CreateSample
SchemaForRequestBodyApplicationJson = CreateSample


request_body_create_sample = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationVndIlluminaV3json = ProjectSample
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_sample_in_project_oapg(
        self,
    ...
    def _create_sample_in_project_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_sample.serialize(body, content_type)
...
class CreateSampleInProject(BaseApi):
    ...
    def create_sample_in_project(
        ...
        return self._create_sample_in_project_oapg(
            body=body,
