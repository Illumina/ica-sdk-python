...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = Upload
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_upload_url_for_data_oapg(
        self,
...
class CreateUploadUrlForData(BaseApi):
    ...
    def create_upload_url_for_data(
        ...
        return self._create_upload_url_for_data_oapg(
