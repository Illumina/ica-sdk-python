...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = BundlePipelineList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_bundle_pipelines_oapg(
        self,
...
class GetBundlePipelines(BaseApi):
    ...
    def get_bundle_pipelines(
        ...
        return self._get_bundle_pipelines_oapg(
