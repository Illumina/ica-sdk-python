...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = ProjectDataPagedList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_non_sample_project_data_oapg(
        self,
...
class GetNonSampleProjectData(BaseApi):
    ...
    def get_non_sample_project_data(
        ...
        return self._get_non_sample_project_data_oapg(
