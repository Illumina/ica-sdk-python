...
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = ProjectSample
SchemaForRequestBodyApplicationJson = ProjectSample


request_body_project_sample = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = ProjectSample
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_project_sample_oapg(
        self,
    ...
    def _update_project_sample_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_project_sample.serialize(body, content_type)
...
class UpdateProjectSample(BaseApi):
    ...
    def update_project_sample(
        ...
        return self._update_project_sample_oapg(
            body=body,
