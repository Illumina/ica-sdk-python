...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_all_matching_activation_codes_for_cwl_oapg(
        self,
...
class FindAllMatchingActivationCodesForCwl(BaseApi):
    ...
    def find_all_matching_activation_codes_for_cwl(
        ...
        return self._find_all_matching_activation_codes_for_cwl_oapg(
            body=body,
