...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = DownloadRuleList
...
class GetDownloadRules(BaseApi):
    ...
    def get_download_rules(
        ...
        return self._get_download_rules_oapg(
