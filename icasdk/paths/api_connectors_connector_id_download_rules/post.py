...
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = CreateDownloadRule
SchemaForRequestBodyApplicationJson = CreateDownloadRule


request_body_create_download_rule = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_download_rule_oapg(
        self,
    ...
    def _create_download_rule_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_download_rule.serialize(body, content_type)
...
class CreateDownloadRule(BaseApi):
    ...
    def create_download_rule(
        ...
        return self._create_download_rule_oapg(
            body=body,
