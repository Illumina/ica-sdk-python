...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = SampleCreationBatchSampleItem
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_sample_creation_batch_item_oapg(
        self,
...
class GetSampleCreationBatchItem(BaseApi):
    ...
    def get_sample_creation_batch_item(
        ...
        return self._get_sample_creation_batch_item_oapg(
