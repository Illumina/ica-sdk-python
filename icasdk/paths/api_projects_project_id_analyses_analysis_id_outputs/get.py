...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = AnalysisOutputList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_analysis_outputs_oapg(
        self,
...
class GetAnalysisOutputs(BaseApi):
    ...
    def get_analysis_outputs(
        ...
        return self._get_analysis_outputs_oapg(
