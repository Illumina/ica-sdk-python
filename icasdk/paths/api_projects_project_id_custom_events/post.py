...
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = CreateCustomEvent


request_body_create_custom_event = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_custom_event_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_custom_event.serialize(body, content_type)
...
class CreateCustomEvent(BaseApi):
    ...
    def create_custom_event(
        ...
        return self._create_custom_event_oapg(
            body=body,
