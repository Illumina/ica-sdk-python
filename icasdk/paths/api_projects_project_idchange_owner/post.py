...
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = ChangeProjectOwner


request_body_change_project_owner = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _change_project_owner_oapg(
        self,
    ...
    def _change_project_owner_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_change_project_owner.serialize(body, content_type)
...
class ChangeProjectOwner(BaseApi):
    ...
    def change_project_owner(
        ...
        return self._change_project_owner_oapg(
            body=body,
