...
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = CreateNotificationSubscription
SchemaForRequestBodyApplicationJson = CreateNotificationSubscription


request_body_create_notification_subscription = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = NotificationSubscription
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_notification_subscription1_oapg(
        self,
    ...
    def _create_notification_subscription1_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_notification_subscription.serialize(body, content_type)
...
class CreateNotificationSubscription1(BaseApi):
    ...
    def create_notification_subscription1(
        ...
        return self._create_notification_subscription1_oapg(
            body=body,
