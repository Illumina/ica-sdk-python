...
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = SearchMatchingActivationCodesForCwlAnalysis
SchemaForRequestBodyApplicationJson = SearchMatchingActivationCodesForCwlAnalysis


request_body_search_matching_activation_codes_for_cwl_analysis = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_best_matching_activation_code_for_cwl_oapg(
        self,
    ...
    def _find_best_matching_activation_code_for_cwl_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_search_matching_activation_codes_for_cwl_analysis.serialize(body, content_type)
...
class FindBestMatchingActivationCodeForCwl(BaseApi):
    ...
    def find_best_matching_activation_code_for_cwl(
        ...
        return self._find_best_matching_activation_code_for_cwl_oapg(
            body=body,
