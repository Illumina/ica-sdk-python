...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = ProjectDataCopyBatch
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_project_data_copy_batch_oapg(
        self,
...
class GetProjectDataCopyBatch(BaseApi):
    ...
    def get_project_data_copy_batch(
        ...
        return self._get_project_data_copy_batch_oapg(
