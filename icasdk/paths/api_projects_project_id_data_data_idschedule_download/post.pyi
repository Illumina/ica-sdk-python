...
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = ScheduleDownload
SchemaForRequestBodyApplicationJson = ScheduleDownload


request_body_schedule_download = api_client.RequestBody(
    content={
...
SchemaFor0ResponseBodyApplicationVndIlluminaV3json = DataTransfer
...
_response_for_default = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.illumina.v3+json': api_client.MediaType(
            schema=SchemaFor0ResponseBodyApplicationVndIlluminaV3json),
    },
    headers=[
        e_tag_parameter,
    ]
...
class BaseApi(api_client.Api):
    @typing.overload
    def _schedule_download_for_data_oapg(
        self,
    ...
    def _schedule_download_for_data_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_schedule_download.serialize(body, content_type)
...
class ScheduleDownloadForData(BaseApi):
    ...
    def schedule_download_for_data(
        ...
        return self._schedule_download_for_data_oapg(
            body=body,
