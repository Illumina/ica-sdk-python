...
class StatusSchema(
    ...
    class MetaOapg:
        ...
        class items(
            ...
            @schemas.classproperty
            def ALREADY_LINKED(cls):
                return cls("ALREADY_LINKED")
...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = ProjectDataLinkingBatchItemPagedList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_project_data_linking_batch_items_oapg(
        self,
...
class GetProjectDataLinkingBatchItems(BaseApi):
    ...
    def get_project_data_linking_batch_items(
        ...
        return self._get_project_data_linking_batch_items_oapg(
