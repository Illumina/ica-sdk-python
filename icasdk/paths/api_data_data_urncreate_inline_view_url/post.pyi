...
# Path params
DataUrnSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'dataUrn': typing.Union[DataUrnSchema, str, ],
    }
)
...
request_path_data_urn = api_client.PathParameter(
    name="dataUrn",
    style=api_client.ParameterStyle.SIMPLE,
    schema=DataUrnSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = InlineView
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_inline_view_url_for_data_without_project_context_oapg(
        self,
...
class CreateInlineViewUrlForDataWithoutProjectContext(BaseApi):
    ...
    def create_inline_view_url_for_data_without_project_context(
        ...
        return self._create_inline_view_url_for_data_without_project_context_oapg(
