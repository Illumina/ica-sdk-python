...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = SampleCreationBatchItemPagedList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_sample_creation_batch_items_oapg(
        self,
...
class GetSampleCreationBatchItems(BaseApi):
    ...
    def get_sample_creation_batch_items(
        ...
        return self._get_sample_creation_batch_items_oapg(
