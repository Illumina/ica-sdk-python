...
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = CreateAnalysisCreationBatch


request_body_create_analysis_creation_batch = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_analysis_creation_batch_oapg(
        self,
    ...
    def _create_analysis_creation_batch_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_analysis_creation_batch.serialize(body, content_type)
...
class CreateAnalysisCreationBatch(BaseApi):
    ...
    def create_analysis_creation_batch(
        ...
        return self._create_analysis_creation_batch_oapg(
            body=body,
