...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = BundlePagedList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_entitled_bundles_oapg(
        self,
...
class GetEntitledBundles(BaseApi):
    ...
    def get_entitled_bundles(
        ...
        return self._get_entitled_bundles_oapg(
