...
# Path params
StorageConfigurationIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'storageConfigurationId': typing.Union[StorageConfigurationIdSchema, str, ],
    }
)
...
request_path_storage_configuration_id = api_client.PathParameter(
    name="storageConfigurationId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=StorageConfigurationIdSchema,
    required=True,
)
_auth = [
    'ApiKeyAuth',
...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = StorageConfigurationDetails
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_storage_configuration_details_oapg(
        self,
    ...
    def _get_storage_configuration_details_oapg(
        ...
        _path_params = {}
        for parameter in (
            request_path_storage_configuration_id,
        ):
...
class GetStorageConfigurationDetails(BaseApi):
    ...
    def get_storage_configuration_details(
        ...
        return self._get_storage_configuration_details_oapg(
