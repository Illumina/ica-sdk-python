...
UploadRuleIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'connectorId': typing.Union[ConnectorIdSchema, str, ],
        'uploadRuleId': typing.Union[UploadRuleIdSchema, str, ],
    }
)
...
request_path_upload_rule_id = api_client.PathParameter(
    name="uploadRuleId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=UploadRuleIdSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationVndIlluminaV3json = UploadRule
SchemaForRequestBodyApplicationJson = UploadRule


request_body_upload_rule = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndIlluminaV3json = UploadRule
...
class BaseApi(api_client.Api):
    ...
    def _update_upload_rule_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_upload_rule.serialize(body, content_type)
...
class UpdateUploadRule(BaseApi):
    ...
    def update_upload_rule(
        ...
        return self._update_upload_rule_oapg(
            body=body,
