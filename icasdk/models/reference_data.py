...
class ReferenceData(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "species": Species.from_dict(obj.get("species")) if obj.get("species") is not None else None,
            "dataFormat": DataFormat.from_dict(obj.get("dataFormat")) if obj.get("dataFormat") is not None else None,
            "version": obj.get("version"),
            "typeList": ReferenceDataTypeList.from_dict(obj.get("typeList")) if obj.get("typeList") is not None else None
        })
        return _obj
