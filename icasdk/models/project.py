...
class Project(BaseModel):
    ...
    def billing_mode_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('PROJECT', 'TENANT'):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "tags": ProjectTag.from_dict(obj.get("tags")) if obj.get("tags") is not None else None,
            "storageBundle": StorageBundle.from_dict(obj.get("storageBundle")) if obj.get("storageBundle") is not None else None,
            "selfManagedStorageConfiguration": StorageConfiguration.from_dict(obj.get("selfManagedStorageConfiguration")) if obj.get("selfManagedStorageConfiguration") is not None else None,
            "analysisPriority": obj.get("analysisPriority"),
            "metadataModel": MetadataModel.from_dict(obj.get("metadataModel")) if obj.get("metadataModel") is not None else None,
