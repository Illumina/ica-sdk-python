...
class BaseJob(BaseModel):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('COPYTABLE', 'EXPORTTABLE', 'CREATETABLE', 'EXECUTEQUERY', 'LOADDATA', 'PREPAREDATA'):
    ...
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('CREATED', 'SUCCEEDED', 'FAILED', 'PENDING', 'INPROGRESS', 'ABORTED'):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "table": ProjectBaseTable.from_dict(obj.get("table")) if obj.get("table") is not None else None,
            "type": obj.get("type"),
