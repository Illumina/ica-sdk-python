...
class ActivationCodeDetail(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "pipelineBundle": PipelineBundle.from_dict(obj.get("pipelineBundle")) if obj.get("pipelineBundle") is not None else None,
            "usages": [ActivationCodeDetailUsage.from_dict(_item) for _item in obj.get("usages")] if obj.get("usages") is not None else None
        })
        return _obj
