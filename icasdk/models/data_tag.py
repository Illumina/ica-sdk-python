...
class DataTag(BaseModel):
    ...
    DataTag
    """ # noqa: E501
    technical_tags: Optional[List[StrictStr]] = Field(default=None, alias="technicalTags")
    user_tags: Optional[List[StrictStr]] = Field(default=None, alias="userTags")
    connector_tags: Optional[List[StrictStr]] = Field(default=None, alias="connectorTags")
    run_in_tags: Optional[List[StrictStr]] = Field(default=None, alias="runInTags")
    run_out_tags: Optional[List[StrictStr]] = Field(default=None, alias="runOutTags")
    reference_tags: Optional[List[StrictStr]] = Field(default=None, alias="referenceTags")
