...
class FolderUploadSession(BaseModel):
    ...
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('OPEN', 'CLOSED', 'COMPLETED'):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "tempCredentials": TempCredentials.from_dict(obj.get("tempCredentials")) if obj.get("tempCredentials") is not None else None
        })
        return _obj
