...
class WorkflowSessionInput(BaseModel):
    ...
    analysis_data: Optional[List[WorkflowSessionData]] = Field(default=None, description="The workflow-session-data used as input by the workflow session.", alias="analysisData")
    __properties: ClassVar[List[str]] = ["code", "analysisData"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "analysisData": [WorkflowSessionData.from_dict(_item) for _item in obj.get("analysisData")] if obj.get("analysisData") is not None else None
        })
        return _obj
