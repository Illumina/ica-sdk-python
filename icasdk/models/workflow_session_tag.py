...
class WorkflowSessionTag(BaseModel):
    ...
    WorkflowSessionTag
    """ # noqa: E501
    technical_tags: Optional[List[StrictStr]] = Field(default=None, description="Technical tags", alias="technicalTags")
    user_tags: Optional[List[StrictStr]] = Field(default=None, description="User tags", alias="userTags")
