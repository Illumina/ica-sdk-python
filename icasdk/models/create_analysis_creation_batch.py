...
class CreateAnalysisCreationBatch(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cwlItems", "nextflowItems"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.nextflow_items:
            for _item in self.nextflow_items:
                if _item:
                    _items.append(_item.to_dict())
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "cwlItems": [CreateCwlAnalysis.from_dict(_item) for _item in obj.get("cwlItems")] if obj.get("cwlItems") is not None else None,
            "nextflowItems": [CreateNextflowAnalysis.from_dict(_item) for _item in obj.get("nextflowItems")] if obj.get("nextflowItems") is not None else None
        })
        return _obj
