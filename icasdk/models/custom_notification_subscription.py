...
class CustomNotificationSubscription(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timeCreated", "timeModified", "ownerId", "tenantId", "tenantName", "customEventCode", "filterExpression", "enabled", "notificationChannel"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "notificationChannel": NotificationChannel.from_dict(obj.get("notificationChannel")) if obj.get("notificationChannel") is not None else None
        })
        return _obj
