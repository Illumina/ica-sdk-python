...
class CreateNextflowAnalysis(BaseModel):
    ...
    analysis_output: Optional[List[AnalysisOutputMapping]] = Field(default=None, alias="analysisOutput")
    analysis_input: NextflowAnalysisInput = Field(alias="analysisInput")
    __properties: ClassVar[List[str]] = ["userReference", "pipelineId", "tags", "activationCodeDetailId", "analysisStorageId", "outputParentFolderId", "analysisOutput", "analysisInput"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.analysis_output:
            for _item in self.analysis_output:
                if _item:
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "analysisOutput": [AnalysisOutputMapping.from_dict(_item) for _item in obj.get("analysisOutput")] if obj.get("analysisOutput") is not None else None,
            "analysisInput": NextflowAnalysisInput.from_dict(obj.get("analysisInput")) if obj.get("analysisInput") is not None else None
        })
        return _obj
