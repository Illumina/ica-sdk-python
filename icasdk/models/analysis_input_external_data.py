...
class AnalysisInputExternalData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["url", "type", "mountPath", "s3Details"]

    @field_validator('type')
    def type_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"s3|http", value):
            raise ValueError(r"must validate the regular expression /s3|http/")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "s3Details": AnalysisS3DataDetails.from_dict(obj.get("s3Details")) if obj.get("s3Details") is not None else None
        })
        return _obj
