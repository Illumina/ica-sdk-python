...
class AnalysisCreationBatchItem(BaseModel):
    """
    ...
    created_analysis: Optional[Analysis] = Field(default=None, alias="createdAnalysis")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "request": AnalysisCreationBatchItemRequest.from_dict(obj.get("request")) if obj.get("request") is not None else None,
            "processing": AnalysisCreationBatchItemProcessing.from_dict(obj.get("processing")) if obj.get("processing") is not None else None,
            "createdAnalysis": Analysis.from_dict(obj.get("createdAnalysis")) if obj.get("createdAnalysis") is not None else None
        })
        return _obj
