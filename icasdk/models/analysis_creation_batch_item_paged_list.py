...
class AnalysisCreationBatchItemPagedList(BaseModel):
    """
    AnalysisCreationBatchItemPagedList
    """ # noqa: E501
    items: List[AnalysisCreationBatchItem]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "items": [AnalysisCreationBatchItem.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
