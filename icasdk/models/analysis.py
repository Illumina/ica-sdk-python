...
class Analysis(BaseModel):
    ...
    pipeline: Pipeline
    workflow_session: Optional[WorkflowSession] = Field(default=None, alias="workflowSession")
    ...
    analysis_storage: Optional[AnalysisStorage] = Field(default=None, alias="analysisStorage")
    analysis_priority: Optional[StrictStr] = Field(default=None, description="The priority of the analysis", alias="analysisPriority")
    tags: AnalysisTag
    __properties: ClassVar[List[str]] = ["id", "timeCreated", "timeModified", "ownerId", "tenantId", "tenantName", "reference", "userReference", "pipeline", "workflowSession", "status", "startDate", "endDate", "summary", "analysisStorage", "analysisPriority", "tags"]

    @field_validator('status')
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('REQUESTED', 'AWAITINGINPUT', 'INPROGRESS', 'SUCCEEDED', 'FAILED', 'FAILEDFINAL', 'ABORTED'):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "pipeline": Pipeline.from_dict(obj.get("pipeline")) if obj.get("pipeline") is not None else None,
            "workflowSession": WorkflowSession.from_dict(obj.get("workflowSession")) if obj.get("workflowSession") is not None else None,
            "status": obj.get("status"),
            "startDate": obj.get("startDate"),
            "endDate": obj.get("endDate"),
            "summary": obj.get("summary"),
            "analysisStorage": AnalysisStorage.from_dict(obj.get("analysisStorage")) if obj.get("analysisStorage") is not None else None,
            "analysisPriority": obj.get("analysisPriority"),
            "tags": AnalysisTag.from_dict(obj.get("tags")) if obj.get("tags") is not None else None
        })
        return _obj
