...
class Sample(BaseModel):
    ...
    sequencing_runs: Optional[List[SequencingRun]] = Field(default=None, alias="sequencingRuns")
    __properties: ClassVar[List[str]] = ["id", "timeCreated", "timeModified", "ownerId", "tenantId", "tenantName", "name", "description", "tags", "region", "status", "metadataValid", "metadata", "sequencingRuns"]

    @field_validator('status')
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('DELETED', 'AVAILABLE', 'PARTIAL'):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.sequencing_runs:
            for _item in self.sequencing_runs:
                if _item:
                    _items.append(_item.to_dict())
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "tags": SampleTag.from_dict(obj.get("tags")) if obj.get("tags") is not None else None,
            ...
            "sequencingRuns": [SequencingRun.from_dict(_item) for _item in obj.get("sequencingRuns")] if obj.get("sequencingRuns") is not None else None
        })
        return _obj
