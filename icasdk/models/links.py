...
class Links(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "licenses": [Link.from_dict(_item) for _item in obj.get("licenses")] if obj.get("licenses") is not None else None,
            "homepages": [Link.from_dict(_item) for _item in obj.get("homepages")] if obj.get("homepages") is not None else None,
            "publications": [Link.from_dict(_item) for _item in obj.get("publications")] if obj.get("publications") is not None else None
        })
        return _obj
