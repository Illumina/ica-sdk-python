...
class CreateProjectDataUpdateBatch(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.data_update_groups:
            for _item in self.data_update_groups:
                if _item:
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "dataUpdateGroups": [DataUpdateGroup.from_dict(_item) for _item in obj.get("dataUpdateGroups")] if obj.get("dataUpdateGroups") is not None else None
        })
        return _obj
