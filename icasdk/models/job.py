...
class Job(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "status", "additionalStatusInformation", "subjectType", "subjectId", "timeCreated", "timeStarted", "timeFinished", "owner", "project"]

    @field_validator('status')
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('INITIALIZED', 'WAITING_FOR_RESOURCES', 'RUNNING', 'STOPPED', 'SUCCEEDED', 'PARTIALLY_SUCCEEDED', 'FAILED'):
