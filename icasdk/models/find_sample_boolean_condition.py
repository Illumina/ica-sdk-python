...
class FindSampleBooleanCondition(BaseModel):
    ...
    """ # noqa: E501
    metadata_field: Optional[Field] = Field(default=None, alias="metadataField")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "metadataField": Field.from_dict(obj.get("metadataField")) if obj.get("metadataField") is not None else None,
            "field": obj.get("field"),
            "value": obj.get("value")
        })
        return _obj
