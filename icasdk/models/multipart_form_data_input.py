...
class MultipartFormDataInput(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["formDataMap", "formData", "parts", "preamble"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.form_data_map:
            for _key in self.form_data_map:
                if self.form_data_map[_key] is not None:
                    _field_dict_of_array[_key] = [
                        _item.to_dict() for _item in self.form_data_map[_key]
                    ]
        ...
        _field_dict = {}
        if self.form_data:
            for _key in self.form_data:
                if self.form_data[_key]:
                    _field_dict[_key] = self.form_data[_key].to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "formData": dict(
                ...
                for _k, _v in obj.get("formData").items()
            )
            if obj.get("formData") is not None
            else None,
            "parts": [InputPart.from_dict(_item) for _item in obj.get("parts")] if obj.get("parts") is not None else None,
