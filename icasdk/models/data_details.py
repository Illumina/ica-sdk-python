...
class DataDetails(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["timeCreated", "timeModified", "creatorId", "tenantId", "tenantName", "owningProjectId", "owningProjectName", "name", "path", "fileSizeInBytes", "status", "tags", "format", "dataType", "objectETag", "storedForTheFirstTimeAt", "region", "willBeArchivedAt", "willBeDeletedAt", "sequencingRun"]

    @field_validator('status')
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('PARTIAL', 'AVAILABLE', 'ARCHIVING', 'ARCHIVED', 'UNARCHIVING', 'DELETING'):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "tags": DataTag.from_dict(obj.get("tags")) if obj.get("tags") is not None else None,
            "format": DataFormat.from_dict(obj.get("format")) if obj.get("format") is not None else None,
            ...
            "sequencingRun": SequencingRun.from_dict(obj.get("sequencingRun")) if obj.get("sequencingRun") is not None else None
        })
        return _obj
