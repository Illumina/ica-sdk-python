...
class CreateCwlPipeline(BaseModel):
    """
    CreateCwlPipeline
    """ # noqa: E501
    code: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(description="The code of the CWL pipeline")
    description: Annotated[str, Field(min_length=1, strict=True, max_length=4000)] = Field(description="The description of the CWL pipeline")
    workflow_cwl_file: Union[StrictBytes, StrictStr] = Field(description="The CWL workflow file.", alias="workflowCwlFile")
    tool_cwl_files: Optional[List[Union[StrictBytes, StrictStr]]] = Field(default=None, alias="toolCwlFiles")
    ...
    __properties: ClassVar[List[str]] = ["code", "description", "workflowCwlFile", "toolCwlFiles", "parametersXmlFile", "metadataModelFile", "links", "versionComment", "categories", "htmlDocumentation", "analysisStorageId"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "workflowCwlFile": obj.get("workflowCwlFile"),
            "toolCwlFiles": obj.get("toolCwlFiles"),
