...
class ProjectDataCopyBatchItem(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "request": ProjectDataCopyBatchItemRequest.from_dict(obj.get("request")) if obj.get("request") is not None else None,
            "processing": ProjectDataCopyBatchItemProcessing.from_dict(obj.get("processing")) if obj.get("processing") is not None else None,
