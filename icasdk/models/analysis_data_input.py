...
class AnalysisDataInput(BaseModel):
    ...
    mounts: Optional[List[AnalysisInputDataMount]] = None
    external_data: Optional[List[AnalysisInputExternalData]] = Field(default=None, alias="externalData")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "mounts": [AnalysisInputDataMount.from_dict(_item) for _item in obj.get("mounts")] if obj.get("mounts") is not None else None,
            "externalData": [AnalysisInputExternalData.from_dict(_item) for _item in obj.get("externalData")] if obj.get("externalData") is not None else None
        })
        return _obj
