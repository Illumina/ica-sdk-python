...
class UpdateMetadata(BaseModel):
    ...
    update_metadata_field_groups: Optional[List[UpdateMetadataFieldGroup]] = Field(default=None, description="List of metadata field groups to be updated", alias="updateMetadataFieldGroups")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.update_single_metadata_fields:
            for _item in self.update_single_metadata_fields:
                if _item:
        ...
        if self.update_metadata_field_groups:
            for _item in self.update_metadata_field_groups:
                if _item:
                    _items.append(_item.to_dict())
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "updateSingleMetadataFields": [UpdateSingleMetadataField.from_dict(_item) for _item in obj.get("updateSingleMetadataFields")] if obj.get("updateSingleMetadataFields") is not None else None,
            "updateMetadataFieldGroups": [UpdateMetadataFieldGroup.from_dict(_item) for _item in obj.get("updateMetadataFieldGroups")] if obj.get("updateMetadataFieldGroups") is not None else None
        })
        return _obj
