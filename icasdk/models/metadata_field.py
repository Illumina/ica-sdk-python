...
class MetadataField(BaseModel):
    ...
    def field_type_validate_enum(cls, value):
        ...
        if value not in ('TEXT', 'NUMERIC', 'BOOLEAN', 'DATE', 'GROUP'):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.group_values:
            for _item in self.group_values:
                if _item:
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "groupValues": [MetadataField.from_dict(_item) for _item in obj.get("groupValues")] if obj.get("groupValues") is not None else None
        })
        return _obj
