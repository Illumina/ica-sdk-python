...
class CreateSampleCreationBatchSampleItem(BaseModel):
    ...
    data_to_link: Optional[List[CreateSampleCreationBatchDataItem]] = Field(default=None, description="The data to be linked to the new sample.", alias="dataToLink")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.data_to_link:
            for _item in self.data_to_link:
                if _item:
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "sampleToCreate": CreateSample.from_dict(obj.get("sampleToCreate")) if obj.get("sampleToCreate") is not None else None,
            "dataToLink": [CreateSampleCreationBatchDataItem.from_dict(_item) for _item in obj.get("dataToLink")] if obj.get("dataToLink") is not None else None,
