...
class InputPart(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["contentTypeFromMessage", "mediaType", "bodyAsString", "headers"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "mediaType": InputPartMediaType.from_dict(obj.get("mediaType")) if obj.get("mediaType") is not None else None,
