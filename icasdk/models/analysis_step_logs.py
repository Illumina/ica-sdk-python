...
class AnalysisStepLogs(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "stdOutData": Data.from_dict(obj.get("stdOutData")) if obj.get("stdOutData") is not None else None,
            "stdOutStream": obj.get("stdOutStream"),
            "stdErrData": Data.from_dict(obj.get("stdErrData")) if obj.get("stdErrData") is not None else None,
