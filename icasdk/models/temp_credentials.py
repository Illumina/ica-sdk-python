...
class TempCredentials(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "awsTempCredentials": AwsTempCredentials.from_dict(obj.get("awsTempCredentials")) if obj.get("awsTempCredentials") is not None else None,
            "rcloneTempCredentials": RcloneTempCredentials.from_dict(obj.get("rcloneTempCredentials")) if obj.get("rcloneTempCredentials") is not None else None
        })
        return _obj
