...
class CreateStorageCredential(BaseModel):
    ...
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True, max_length=60)] = Field(description="The name of the credentials")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "type": obj.get("type"),
            "awsCredentials": AwsCredentials.from_dict(obj.get("awsCredentials")) if obj.get("awsCredentials") is not None else None
        })
        return _obj
