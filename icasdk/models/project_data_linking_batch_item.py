...
class ProjectDataLinkingBatchItem(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if created_project_data (nullable) is None
        # and model_fields_set contains the field
        if self.created_project_data is None and "created_project_data" in self.model_fields_set:
            _dict['createdProjectData'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "request": ProjectDataLinkingBatchItemRequest.from_dict(obj.get("request")) if obj.get("request") is not None else None,
            "processing": ProjectDataLinkingBatchItemProcessing.from_dict(obj.get("processing")) if obj.get("processing") is not None else None,
            "createdProjectData": ProjectData.from_dict(obj.get("createdProjectData")) if obj.get("createdProjectData") is not None else None
        })
        return _obj
