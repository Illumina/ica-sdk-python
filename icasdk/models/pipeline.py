...
class Pipeline(BaseModel):
    ...
    analysis_storage: AnalysisStorage = Field(alias="analysisStorage")
    __properties: ClassVar[List[str]] = ["id", "timeCreated", "timeModified", "ownerId", "tenantId", "tenantName", "code", "urn", "description", "language", "languageVersion", "pipelineTags", "analysisStorage"]

    @field_validator('language')
    def language_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('CWL', 'NEXTFLOW', 'UNKNOWN'):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "languageVersion": PipelineLanguageVersion.from_dict(obj.get("languageVersion")) if obj.get("languageVersion") is not None else None,
            "pipelineTags": PipelineTag.from_dict(obj.get("pipelineTags")) if obj.get("pipelineTags") is not None else None,
