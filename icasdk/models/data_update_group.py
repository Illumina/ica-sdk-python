...
class DataUpdateGroup(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["dataIds", "userTags", "technicalTags"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "userTags": TagUpdate.from_dict(obj.get("userTags")) if obj.get("userTags") is not None else None,
            "technicalTags": TagUpdate.from_dict(obj.get("technicalTags")) if obj.get("technicalTags") is not None else None
        })
        return _obj
