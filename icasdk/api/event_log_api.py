...
class EventLogApi:
    ...
    def get_event_logs(
        ...
        rows: Annotated[Optional[StrictInt], Field(description="Amount of rows to fetch. Maximum 250. Defaults to 250")] = None,
        ...
        :type date_until: str
        :param rows: Amount of rows to fetch. Maximum 250. Defaults to 250
        :type rows: int
