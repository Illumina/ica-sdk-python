...
class ProjectNotificationSubscriptionsApi:
    ...
    def create_notification_subscription1(
        ...
        _param = self._create_notification_subscription1_serialize(
    ...
    @validate_call
    def create_notification_subscription1_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="The ID of the project")],
        create_notification_subscription: Annotated[CreateNotificationSubscription, Field(description="The new subscription")],
        _request_timeout: Union[
    ...
    @validate_call
    def create_notification_subscription1_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="The ID of the project")],
        create_notification_subscription: Annotated[CreateNotificationSubscription, Field(description="The new subscription")],
        _request_timeout: Union[
    ...
    def _create_notification_subscription1_serialize(
        self,
        project_id,
    ...
    def delete_notification_subscription1(
        ...
        _param = self._delete_notification_subscription1_serialize(
            project_id=project_id,
    ...
    @validate_call
    def delete_notification_subscription1_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="The ID of the project")],
        subscription_id: Annotated[StrictStr, Field(description="The ID of the notification subscription to delete")],
        _request_timeout: Union[
    ...
    @validate_call
    def delete_notification_subscription1_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="The ID of the project")],
        subscription_id: Annotated[StrictStr, Field(description="The ID of the notification subscription to delete")],
        _request_timeout: Union[
    ...
    def _delete_notification_subscription1_serialize(
        self,
        project_id,
        subscription_id,
        _request_auth,
    ...
    def get_notification_subscription1(
        ...
        _param = self._get_notification_subscription1_serialize(
            project_id=project_id,
            subscription_id=subscription_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_notification_subscription1_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="The ID of the project")],
        subscription_id: Annotated[StrictStr, Field(description="The ID of the notification subscription")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_notification_subscription1_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="The ID of the project")],
        subscription_id: Annotated[StrictStr, Field(description="The ID of the notification subscription")],
        _request_timeout: Union[
    ...
    def _get_notification_subscription1_serialize(
        self,
        project_id,
        subscription_id,
        _request_auth,
    ...
    def get_notification_subscriptions1(
        ...
        _param = self._get_notification_subscriptions1_serialize(
            project_id=project_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_notification_subscriptions1_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="The ID of the project")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_notification_subscriptions1_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="The ID of the project")],
        _request_timeout: Union[
            None,
    ...
    def _get_notification_subscriptions1_serialize(
        self,
        project_id,
        _request_auth,
        _content_type,
    ...
    def update_notification_subscription1(
        ...
        _param = self._update_notification_subscription1_serialize(
            project_id=project_id,
            subscription_id=subscription_id,
    ...
    @validate_call
    def update_notification_subscription1_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="The ID of the project")],
        subscription_id: Annotated[StrictStr, Field(description="The ID of the notification subscription to update")],
        notification_subscription: Annotated[NotificationSubscription, Field(description="The updated subscription")],
    ...
    @validate_call
    def update_notification_subscription1_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="The ID of the project")],
        subscription_id: Annotated[StrictStr, Field(description="The ID of the notification subscription to update")],
        notification_subscription: Annotated[NotificationSubscription, Field(description="The updated subscription")],
    ...
    def _update_notification_subscription1_serialize(
        self,
        project_id,
        subscription_id,
